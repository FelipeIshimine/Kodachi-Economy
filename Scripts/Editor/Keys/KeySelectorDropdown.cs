...
{
    internal sealed class KeySelectorDropdown : EditorWindow
    {
        ...
        internal static void Show(Rect worldBound, Type keyType, SerializedProperty property, Action onChanged)
        {
            ...
            var win        = CreateInstance<KeySelectorDropdown>();
        ...
        private void Refresh()
        {
            ...
            // Create sentinel only appears when there is something to name
        ...
        {
            var folder = EconomyEditorSettings.instance.GetFolderForType(_keyType);
            EnsureFolder(folder);
